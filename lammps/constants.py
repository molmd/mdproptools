...
MASS_CONVERSION = {'real': 10**-3 / AVOGADRO,       # from grams/mole to kg
                   ...
                   'nano': 10**-3 * 10**-18}        # from attograms to kg

DISTANCE_CONVERSION = {'real': 10**-10,             # from Angstroms to m
                       ...
                       'nano': 10**-9}              # from nanometers to m

TIME_CONVERSION = {'real': 10**-15,         # from femtoseconds to s
                   ...
                   'nano': 10**-9}          # from nanoseconds to s

ENERGY_CONVERSION = {'real': 10**3 * CAL_TO_J / AVOGADRO,   # kcal/mol to J
                     'metal': ELEMENTARY_CHARGE,            # eV to J
                     'si': 1,                               # Joules to J
                     'cgs': 10**-7,                         # erg to J
                     'electron': HA_TO_J,                   # Hartree to J
                     'micro': MASS_CONVERSION['micro'],     # pg*mum^2/mus^2 to J
                     'nano': MASS_CONVERSION['nano']}       # ag*nm^2/ns^2 to J

VELOCITY_CONVERSION = {'real': DISTANCE_CONVERSION['real'] / TIME_CONVERSION['real'],
...
FORCE_CONVERSION = {'real': ENERGY_CONVERSION['real'] / DISTANCE_CONVERSION['real'],
...
PRESSURE_CONVERSION = {'real': 101325,          # atm to Pa
...
VISCOSITY_CONVERSION = {'real': 0.1,        # P to Pa*s
                        'metal': 0.1,       # P to Pa*s
                        'si': 1,            # Pa*s to Pa*s
                        'cgs': 0.1,         # P to Pa*s
...
CHARGE_CONVERSION = {'real': ELEMENTARY_CHARGE,         # e to C
                     'metal': ELEMENTARY_CHARGE,        # e to C
                     'si': 1,                           # C to C
                     'cgs': 1 / 10 / LIGHT_SPEED,       # esu to C
                     'electron': ELEMENTARY_CHARGE,     # e to C
                     'micro': 10**-12,                  # pC to C
                     'nano': ELEMENTARY_CHARGE}         # e to C

DIPOLE_CONVERSION = {'real': CHARGE_CONVERSION['real'] * DISTANCE_CONVERSION['real'],
...
ELECTRIC_FIELD_CONVERSION = {'real': 1 / DISTANCE_CONVERSION['real'],
...
DENSITY_3D_CONVERSION = {'real': MASS_CONVERSION['cgs'] / DISTANCE_CONVERSION['cgs']**3,
